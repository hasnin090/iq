...
export default function Transactions() {
  ...
  return (
    <div className="min-h-screen w-full max-w-full overflow-x-hidden">
      <div className="py-6 px-4 pb-mobile-nav-large max-w-full">
        <div className="mb-8">
        ...
        <div className="bg-[hsl(var(--card))] border border-[hsl(var(--border))] p-5 rounded-xl shadow-sm fade-in max-w-full overflow-hidden">
