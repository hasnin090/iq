...
import { AlertCircle, Check, Loader2, Shield, Key, Download, Upload, Database, FileText, HardDrive, AlertTriangle, Plus, Edit, Trash2, Tag, Settings as SettingsIcon, Building } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 dark:from-slate-900 dark:to-blue-900">
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} defaultValue="general" className="space-y-8">
          {/* Navigation Cards */}
            ...
            >
              <Card className="w-full h-24 cursor-pointer transition-all duration-300 hover:shadow-lg hover:-translate-y-1 group-data-[state=active]:ring-2 group-data-[state=active]:ring-primary group-data-[state=active]:bg-primary/5">
                <CardContent className="flex flex-col items-center justify-center h-full p-4">
                  <Settings className="h-6 w-6 text-primary mb-2 group-data-[state=active]:text-primary" />
          ...
          {/* Content Area */}
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border min-h-[600px]">
